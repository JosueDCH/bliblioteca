...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAnadirClientePrincipal = new javax.swing.JButton();
        jButton7 = new javax.swing.JButton();
        PanelPrincipal = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Biblioteca");
        setBackground(new java.awt.Color(30, 80, 250));
        ...
        btnHome.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        btnAnadirClientePrincipal.setBackground(new java.awt.Color(255, 255, 255));
        btnAnadirClientePrincipal.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        btnAnadirClientePrincipal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/CrearUsuario.png"))); // NOI18N
        btnAnadirClientePrincipal.setText("Añadir Cliente");
        btnAnadirClientePrincipal.setBorderPainted(false);
        btnAnadirClientePrincipal.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnAnadirClientePrincipal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btnAnadirClientePrincipal.setOpaque(false);
        btnAnadirClientePrincipal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAnadirClientePrincipalActionPerformed(evt);
            }
        });
        ...
        PanelAccesoLayout.setHorizontalGroup(
            ...
            .addGroup(PanelAccesoLayout.createSequentialGroup()
                ...
                .addGroup(PanelAccesoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnAnadirClientePrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        PanelAccesoLayout.setVerticalGroup(
            ...
            .addGroup(PanelAccesoLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnAnadirClientePrincipal)
                .addGap(18, 18, 18)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(PanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 1017, Short.MAX_VALUE)
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(PanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 624, Short.MAX_VALUE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Devolucion.setSize(1000, 600);//tama;o
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        PanelPendientesDevolver Pendientes = new PanelPendientesDevolver();
        Pendientes.setSize(1000, 600);//tama;o
        Pendientes.setLocation(5, 5);//posicion

        PanelPrincipal.removeAll();
        PanelPrincipal.add(Pendientes, BorderLayout.CENTER);
        PanelPrincipal.revalidate();
        PanelPrincipal.repaint();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void btnAnadirClientePrincipalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnadirClientePrincipalActionPerformed
//        con.conectar();
//        JOptionPane.showMessageDialog(null, "Presiono el boton 6");
        
        PanelVistaCliente VistaCliente = new PanelVistaCliente();
        VistaCliente.setSize(1000, 600);//tama;o
        VistaCliente.setLocation(5, 5);//posicion
        
//        String q="SELECT CLIENTES_SEQ.CURRVAL FROM DUAL";
//        ResultSet resp;
//        try {
//            resp=con.getData(q);
//            int count=0;
...
//            }
//            if(count>0){
//                System.out.println("NextVal: "+resp.getString("CURRVAL"));
//            }
//        } catch (Exception e) {
//        }

        PanelPrincipal.removeAll();
        PanelPrincipal.add(VistaCliente, BorderLayout.CENTER);
        PanelPrincipal.revalidate();
        PanelPrincipal.repaint();
    }//GEN-LAST:event_btnAnadirClientePrincipalActionPerformed
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        PanelAddLibro agregarlibro = new PanelAddLibro();
        agregarlibro.setSize(1000, 600);//tama;o
        agregarlibro.setLocation(5, 5);//posicion

        PanelPrincipal.removeAll();
        PanelPrincipal.add(agregarlibro, BorderLayout.CENTER);
        PanelPrincipal.revalidate();
        PanelPrincipal.repaint();
    ...
    private javax.swing.JButton btnAnadirClientePrincipal;
